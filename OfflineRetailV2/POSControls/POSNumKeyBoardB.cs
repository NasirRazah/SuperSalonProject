...
{
    public partial class POSNumKeyBoardB : DevExpress.XtraEditors.XtraUserControl
    {
        public POSNumKeyBoardB()
        {
            InitializeComponent();
        }
        ...
        public void RearrangeForCalculatorStyle(bool bCalculatorStyle)
        {
            ...
            {
                this.SuspendLayout();
                btn3.Location = new Point(202, 184);
                btn2.Location = new Point(102, 184);
                btn1.Location = new Point(2, 184);


                btn9.Location = new Point(202, 2);
                btn8.Location = new Point(102, 2);
                btn7.Location = new Point(2, 2);
                this.ResumeLayout();
            }
        }
