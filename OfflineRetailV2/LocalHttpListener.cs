...
namespace OfflineRetailV2
{
    public class LocalHttpListener
    {
        ...
        public static void StartWebServer(OfflineRetailV2.UserControls.Administrator.frm_GeneralSetupDlg frm1)
        {
        ...
        private static async Task MainLoop(OfflineRetailV2.UserControls.Administrator.frm_GeneralSetupDlg frm1)
        {
            Listener.Start();
        ...
        private static void ProcessRequest(HttpListenerContext context, OfflineRetailV2.UserControls.Administrator.frm_GeneralSetupDlg frm1)
        {
        ...
        private static bool HandleCallbackRequest(HttpListenerContext context, OfflineRetailV2.UserControls.Administrator.frm_GeneralSetupDlg frm1, HttpListenerResponse response)
        {
