/*
 purpose :  OnScreen English Keyboard 
 USER CLASS : OnScreen English Keyboard 
 */
using System;
    ...
    public partial class PopupKeyBoard : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void ChangeKeyBoardLayOut()
        {
            if (bAlphaKyBrd)
            {
                ...
                btnT.Location = new Point(128, 164);
                btnU.Location = new Point(184, 164);
                btnV.Location = new Point(240, 164);
                btnW.Location = new Point(296, 164);
                btnX.Location = new Point(352, 164);
                btnY.Location = new Point(408, 164);
                btnZ.Location = new Point(464, 164);
            }
            else
            {
                ...
                btnZ.Location = new Point(128, 164);
                btnX.Location = new Point(184, 164);
                btnC.Location = new Point(240, 164);
                btnV.Location = new Point(296, 164);
                btnB.Location = new Point(352, 164);
                btnN.Location = new Point(408, 164);
                btnM.Location = new Point(464, 164);
            }
        }    
        ...
        private void WriteCharacter(string Ch)
        {
            ...
            else
            {
                ...
                //}
                //if (fcalledform.Name == "frmSCALE_600")
                //{
                //    (fcalledform as frmSCALE_600).DelegateKey(Ch);
                //}
