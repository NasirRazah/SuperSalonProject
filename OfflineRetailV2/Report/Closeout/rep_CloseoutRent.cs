/*
 USER CLASS : Report - Closeout (Rent)
 */
using System;
...
{
    public partial class repCloseoutRent : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void xrTableCell87_BeforePrint(object sender, CancelEventArgs e)
        {
            GetLessTotalBeforePrint(sender);
        }

        private void xrTableCell71_PrintOnPage(object sender, PrintOnPageEventArgs e)
        {
        ...
        private void xrTableCell82_BeforePrint(object sender, CancelEventArgs e)
        {
            GetTotalBeforePrintTax2(sender);
        }

        private void xrTableCell76_BeforePrint(object sender, CancelEventArgs e)
        {
        ...
        private void xrTableCell87_PrintOnPage(object sender, PrintOnPageEventArgs e)
        {
            FormatDouble1(sender);
        }

        private void xrTableCell91_PrintOnPage(object sender, PrintOnPageEventArgs e)
        {
            FormatInt(sender);
        }

        private void xrTableCell89_BeforePrint(object sender, CancelEventArgs e)
        {
            GetLessTotalBeforePrint(sender);
        }
