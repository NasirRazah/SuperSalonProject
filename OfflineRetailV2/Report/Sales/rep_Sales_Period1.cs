/*
 USER CLASS : Report - Sales by Period (1)
 */
using System;
...
{
    public partial class repSales_Period1 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        {
            dblPft = GeneralFunctions.fnDouble(rTot4.Text);
        ...
        {
            if ((rTot5.Text == "") || (rTot5.Text.Contains("%")) || (rTot5.Text.Contains("("))) return;
            if (GeneralFunctions.fnDouble(rTot5.Text) != -99999)
            {
                if (intDecimalPlace == 3) rTot5.Text = GeneralFunctions.fnDouble(rTot5.Text).ToString("f3");
                else rTot5.Text = GeneralFunctions.fnDouble(rTot5.Text).ToString("f");
