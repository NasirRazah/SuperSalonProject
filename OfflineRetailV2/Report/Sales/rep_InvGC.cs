/*
 USER CLASS : Report - Receipt (Gift Cert. Info)
 */
using System;
...
{
    public partial class repInvGC : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        {
            rGCName.Text = OfflineRetailV2.Properties.Resources.GC + rGCName.Text;
        }
