/*
 USER CLASS : Report - Customer Label
 */
using System;
...
{
    public partial class repCustomerLabel : DevExpress.XtraReports.UI.XtraReport
    {
        int skipnumber;
        int printnumber;
        int pageno;
        ...
        public repCustomerLabel(int skip, int qty)
        {
            InitializeComponent();
        ...
        private void rCompany_BeforePrint(object sender, CancelEventArgs e)
        {
            DevExpress.Data.Browsing.DataBrowser browser = this.fDataContext[this.DataSource, this.DataMember];
