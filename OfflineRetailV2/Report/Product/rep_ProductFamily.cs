/*
 USER CLASS : Report - Item Listing (By Family)
 */ 
using System;
...
{
    public partial class repProductFamily : DevExpress.XtraReports.UI.XtraReport
    {
        private int intDecimalPlace;
        private int intPDecimalPlace;
        int TotalCount = 0;
        public repProductFamily()
        {
            InitializeComponent();
        ...
        private void rCount_SummaryRowChanged(object sender, EventArgs e)
        {
            TotalCount++;
        }

        private void rCount_SummaryReset(object sender, EventArgs e)
        {
            TotalCount = 0;
        }

        private void rCount_SummaryGetResult(object sender, SummaryGetResultEventArgs e)
        {
            e.Result = TotalCount;
            e.Handled = true;
        }
