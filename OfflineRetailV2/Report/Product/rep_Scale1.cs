/*
 USER CLASS : Report - Scale Listing (1)
 */
using System;
...
{
    public partial class repScale1 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        {
            if (rType.Text == "Random Weight")
            {
                rType.Text = OfflineRetailV2.Properties.Resources.RandomWeight;
            }
            else if (rType.Text == "Fixed Weight")
            {
                rType.Text = OfflineRetailV2.Properties.Resources.FixedWeight;
            }
            else
            {
                rType.Text = OfflineRetailV2.Properties.Resources.ByCount;
            }
        }
    }
}
