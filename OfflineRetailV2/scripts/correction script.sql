GO
Alter table CentralExportCloseOut Add EmployeeName nvarchar(50) NULL;
GO
Alter table CentralExportCloseOut Add ExpFlag char(1) NULL default 'N';
GO
Alter table CentralExportCloseOutReportMain add EmpName nvarchar(50) NULL;
GO
Alter table CentralExportCloseOutReportTender add CloseoutType char(1) NULL;
GO
Alter table CentralExportCloseOutReturn add CloseoutType char(1) NULL;
GO
Alter table CentralExportCloseOutSalesDept add EmpName nvarchar(50) NULL;
GO
Alter table CentralExportCloseOutSalesHour add EmpName nvarchar(50) NULL;
GO
alter table CentralExportPOHeader add POHeaderID int NULL;
GO
alter table CentralExportPOHeader add RefNo varchar(16) NULL;
GO
...
alter procedure [dbo].[sp_co_imp_updttag_closeout]
as
  ...
  begin
    ...
    if @iDpc = 0 begin
     ...
     insert into Product( SKU,Description,ProductType,PriceA,PriceB,PriceC,Cost,QtyOnHand,ReorderQty,NormalQty,DepartmentID,CategoryID,FoodStampEligible,
                                 ...
                                 ScaleFontColor,ScaleIsBold,ScaleIsItalics,SplitWeight,UOM )
  ...
  select @iDpc = count(*) from Dept where DepartmentID = @DeptID;
    ...
    if @iDpc = 0 begin
     ...
     update Product set  SKU = @SKU,Description = @PDesc,ProductType = @PType,PriceA = @PPriceA,PriceB = @PPriceB,
				   ...
				   Tare2=@Tare2,POSDisplayOrder=@ItemDisplayOrder,SplitWeight=@SplitWeight,UOM=@UOM where ID = @PID;
...
ALTER procedure [dbo].[sp_initializereceipts]
  	@ReturnID	int output
...
CREATE TABLE [dbo].[CardTrans](
	...
	[LastChangedOn] [datetime] NULL,
	[AuthCode] [varchar](16) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	[RefCardAuthID] [varchar](20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[RefCardTranID] [varchar](20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
